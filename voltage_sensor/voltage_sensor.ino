int adc_max = 514;                // Maximum sensor value during calibration
int adc_min = 504;                // Minimum sensor value during calibration
 
float volt_multi = 227;           // RMS voltage obtained from a multimeter
